                    ...
                    VStack(spacing: 40) {
                        ...
                        VStack(spacing: 24) {
                            ...
                            VStack(spacing: 12) {
                                ...
                                Text("The server is requesting proof of your verified \(credentialName). Your actual \(credentialName) will not be shared - only cryptographic proof that you own a verified email.")
                                    .font(.system(size: 12))
                        ...
                        VStack(alignment: .leading, spacing: 24) {
                            ...
                            VStack(spacing: 16) {
                                SimpleCardView(
                                    ...
                                    description: "Proof that you have a verified \(credentialName) credential",
                                    action: {
                                ...
                                SimpleCardView(
                                    ...
                                    title: "Personal Data",
                                    description: "❌ Your actual \(credentialName) will NOT be shared",
                                    action: {
