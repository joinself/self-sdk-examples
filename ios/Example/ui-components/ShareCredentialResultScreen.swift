...
public struct ShareCredentialResultScreen: View {
    ...
    public init(success: Bool, credentialName: String, onContinue: @escaping () -> Void, onBack: @escaping () -> Void) {
...
#Preview {
    VStack {
        ShareCredentialResultScreen(success: true, credentialName: "Custom Credential", onContinue: {
