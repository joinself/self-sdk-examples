                    ...
                    VStack(spacing: 40) {
                        ...
                        VStack(spacing: 24) {
                            ...
                            VStack(spacing: 12) {
                                ...
                                CardView(icon: "checkmark.seal.fill", iconColor: .green, title: "Verification Complete", description: "Your email address has been successfully verified and a secure credential has been created on your device.")
                            }
                        }
...
#Preview {
    VerifyEmailResultScreen(credentialName: "Email") {
